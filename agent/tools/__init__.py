...
SPECIALIST_TOOLS: dict[str, list] = {
    "planner": [vivo_poi_search, get_weather, get_traffic, jump_ota],  # 找真实景点/餐厅 + 看天气 + 交通距离 + 预订链接
...
ALL_TOOLS = [vivo_poi_search, get_weather, vivo_ocr, get_traffic, jump_ota]

__all__ = [
    "SPECIALIST_TOOLS", "ALL_TOOLS",
    "vivo_poi_search", "get_weather", "vivo_ocr", "get_traffic", "jump_ota",
]
